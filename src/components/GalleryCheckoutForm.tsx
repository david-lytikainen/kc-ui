...
export default function GalleryCheckoutForm({ email, isStartingCheckout, onCancel, onEmailChange, onStartCheckout, pendingLabel = "Starting...", submitLabel = "Start checkout" }: GalleryCheckoutFormProps) {
  return (
